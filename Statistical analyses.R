...
# Calculation
{
  ...
  for (ID in DatasetID_list) {
    ...
    Pollen_percentages_timeslice_site_0_21ka <- data.frame(matrix(999, nrow=length(timeslice_list), ncol=ncol(Pollen_percentages_sample_site_Asia_0_21ka)-5, byrow=TRUE))
...
# -------------------------------------------------------------------------------------------------
{
  # (1) Assign ICE5G to grid-cell (3.75° resolution)
  {
    ...
    for(t in 1:length(timeslice_list)){
      ...
      Ice_ICE5G_box <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
      colnames(Ice_ICE5G_box) <- c("Longitude","Latitude", "Timeslice", "Grid_number", "Resampling", "ICE5G")
      ...
      for (i in 1:nrow(Coordinate_list_T31)) {
        ...
        if(nrow(subset_site)>0){
          ...
          if(nrow(subset_site) == 1) {
            ...
            Ice_ICE5G_box[Ice_ICE5G_box$Longitude == Coordinate_list_T31[i, 1] & Ice_ICE5G_box$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
            Ice_ICE5G_box[Ice_ICE5G_box$Longitude == Coordinate_list_T31[i, 1] & Ice_ICE5G_box$Latitude == Coordinate_list_T31[i, 2], 6]     <- subset_site$ICE5G
            ...
            if(sum(table(subset_site$ICE5G) == max(table(subset_site$ICE5G))) == 1) {
              ...
              Ice_ICE5G_box[Ice_ICE5G_box$Longitude == Coordinate_list_T31[i, 1] & Ice_ICE5G_box$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
              Ice_ICE5G_box[Ice_ICE5G_box$Longitude == Coordinate_list_T31[i, 1] & Ice_ICE5G_box$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(subset_site$ICE5G))[which.max(table(subset_site$ICE5G))]
              
            } else {
              
              # Handle ties with resampling
              Ice_ICE5G_box[Ice_ICE5G_box$Longitude == Coordinate_list_T31[i, 1] & Ice_ICE5G_box$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
              sampled_elements <- replicate(999, sample(names(table(subset_site$ICE5G)[table(subset_site$ICE5G) == max(table(subset_site$ICE5G))]), size = 1, replace = TRUE))
              Ice_ICE5G_box[Ice_ICE5G_box$Longitude == Coordinate_list_T31[i, 1] & Ice_ICE5G_box$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
          ...
          Ice_ICE5G_box[Ice_ICE5G_box$Longitude == Coordinate_list_T31[i, 1] & Ice_ICE5G_box$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
  ...
  # (2) Creat Ice-sheet ensemble
  {
    # Process ICE5G data
    ICE5G_ice_sheet_grid[ ,6]       <- ifelse(ICE5G_ice_sheet_grid[ ,6] == 100, -2, NA)
    ...
    ICE5G_ICE6G_GLAC1D_ice_sheet_timeslice_grid <- full_join(ICE6G_GLAC1D_ice_sheet_timeslice, ICE5G_ice_sheet_grid[ ,c(1:3,6)], by = c("Longitude", "Latitude", "Timeslice"))
...
# 3.3 Assign reconstructed biome at timeslice of site to grid-cell 
# -------------------------------------------------------------------------------------------------
{
  # Define the timeslices for analysis
  timeslice_list <- seq(0,21,by=0.5)
  ...
  for(t in 1:length(timeslice_list)){
    ...
    timeslice_pollen_subset <- subset(Reconstructed_simulated_biome_timeslice_site_0_21ka_excluded[ ,1:5], Timeslice == timeslice_list[t])
    
    # Initialize a result matrix for the current timeslice
    biome_pollen_grid <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
    colnames(biome_pollen_grid) <- c("Longitude","Latitude", "Timeslice", "Site_number", "Resampling", "Pollen-based reconstruction")
    ...
    for (i in 1:nrow(Coordinate_list_T31)) {
      ...
      if(nrow(site_timeslice_pollen_subset)>0){
        ...
        if(nrow(site_timeslice_pollen_subset) == 1) {
          ...
          biome_pollen_grid[biome_pollen_grid$Longitude == Coordinate_list_T31[i, 1] & biome_pollen_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
          biome_pollen_grid[biome_pollen_grid$Longitude == Coordinate_list_T31[i, 1] & biome_pollen_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- site_timeslice_pollen_subset$`Pollen-based reconstruction`
          ...
          if(sum(table(site_timeslice_pollen_subset$`Pollen-based reconstruction`) == max(table(site_timeslice_pollen_subset$`Pollen-based reconstruction`))) == 1) {
            ...
            biome_pollen_grid[biome_pollen_grid$Longitude == Coordinate_list_T31[i, 1] & biome_pollen_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
            biome_pollen_grid[biome_pollen_grid$Longitude == Coordinate_list_T31[i, 1] & biome_pollen_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(site_timeslice_pollen_subset$`Pollen-based reconstruction`))[which.max(table(site_timeslice_pollen_subset$`Pollen-based reconstruction`))]
            
          } else {
            
            # Handle ties by sampling
            biome_pollen_grid[biome_pollen_grid$Longitude == Coordinate_list_T31[i, 1] & biome_pollen_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
            
            sampled_elements <- replicate(999, sample(names(table(site_timeslice_pollen_subset$`Pollen-based reconstruction`)[table(site_timeslice_pollen_subset$`Pollen-based reconstruction`) == max(table(site_timeslice_pollen_subset$`Pollen-based reconstruction`))]), size = 1, replace = TRUE))
            
            biome_pollen_grid[biome_pollen_grid$Longitude == Coordinate_list_T31[i, 1] & biome_pollen_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
          }
        ...
        biome_pollen_grid[biome_pollen_grid$Longitude == Coordinate_list_T31[i, 1] & biome_pollen_grid$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
...
# 3.4 Creat simulated biome ensemble for grid-cell 
# -------------------------------------------------------------------------------------------------
{
  ...
  for(t in 1:length(timeslice_list)){
    ...
    timeslice_subset <- subset(Reconstructed_simulated_biome_timeslice_site_0_21ka_excluded[ ,c(1:4,6:11)], Timeslice == timeslice_list[t])
    
    # Initialize a result matrix for the current timeslice
    Simulated_ensemble_biome_timeslice_grid <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
    colnames(Simulated_ensemble_biome_timeslice_grid) <- c("Longitude","Latitude", "Timeslice", "Site_number", "Resampling", "Simulation_Ensemble")
    ...
    for (i in 1:nrow(Coordinate_list_T31)) {
      ...
      if(nrow(subset_site)>0){
        ...
        if(sum(frequency == max(frequency)) == 1) {
          ...
          Simulated_ensemble_biome_timeslice_grid[Simulated_ensemble_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & Simulated_ensemble_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
          Simulated_ensemble_biome_timeslice_grid[Simulated_ensemble_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & Simulated_ensemble_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(frequency)[which.max(frequency)]
          
        } else {
          
          # If there are ties, resolve using sampling
          Simulated_ensemble_biome_timeslice_grid[Simulated_ensemble_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & Simulated_ensemble_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
          
          sampled_elements <- replicate(999, sample(names(frequency[frequency == max(frequency)]), size = 1, replace = TRUE))
          
          Simulated_ensemble_biome_timeslice_grid[Simulated_ensemble_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & Simulated_ensemble_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
        }
        ...
        Simulated_ensemble_biome_timeslice_grid[Simulated_ensemble_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & Simulated_ensemble_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
...
# 3.5 Assign simulated biome at timeslice of site to grid-cell 
# -------------------------------------------------------------------------------------------------
{
  # (1) MPI-ESM_GLAC1D
  {
    ...
    for(t in 1:length(timeslice_list)){
      ...
      timeslice_subset <- subset(Reconstructed_simulated_biome_timeslice_site_0_21ka_excluded[ ,c(1:4,6)], Timeslice == timeslice_list[t])
      
      # Initialize a result matrix for the current timeslice
      MPI_GLAC1D_biome_timeslice_grid <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
      colnames(MPI_GLAC1D_biome_timeslice_grid) <- c("Longitude","Latitude", "Timeslice", "Site_number", "Resampling", "MPI-ESM_GLAC1D")
      ...
      for (i in 1:nrow(Coordinate_list_T31)) {
        ...
        if(nrow(subset_site)>0){
          ...
          if(nrow(subset_site) == 1) {
            ...
            MPI_GLAC1D_biome_timeslice_grid[MPI_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
            MPI_GLAC1D_biome_timeslice_grid[MPI_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- subset_site$`MPI-ESM_GLAC1D`
            ...
            if(sum(table(subset_site$`MPI-ESM_GLAC1D`) == max(table(subset_site$`MPI-ESM_GLAC1D`))) == 1) {
              ...
              MPI_GLAC1D_biome_timeslice_grid[MPI_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
              MPI_GLAC1D_biome_timeslice_grid[MPI_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(subset_site$`MPI-ESM_GLAC1D`))[which.max(table(subset_site$`MPI-ESM_GLAC1D`))]
              
            } else {
              
              # Handle ties using sampling
              MPI_GLAC1D_biome_timeslice_grid[MPI_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
              
              sampled_elements <- replicate(999, sample(names(table(subset_site$`MPI-ESM_GLAC1D`)[table(subset_site$`MPI-ESM_GLAC1D`) == max(table(subset_site$`MPI-ESM_GLAC1D`))]), size = 1, replace = TRUE))
              
              MPI_GLAC1D_biome_timeslice_grid[MPI_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
            }
          ...
          MPI_GLAC1D_biome_timeslice_grid[MPI_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
  ...
  # (2) MPI-ESM_ICE6G
  {
    ...
    for(t in 1:length(timeslice_list)){
      ...
      # Subset the data for the current timeslice
      timeslice_subset <- subset(Reconstructed_simulated_biome_timeslice_site_0_21ka_excluded[ ,c(1:4,7)], Timeslice == timeslice_list[t])
      
      # Initialize a result matrix for the current timeslice
      MPI_ICE6G_biome_timeslice_grid <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
      colnames(MPI_ICE6G_biome_timeslice_grid) <- c("Longitude","Latitude", "Timeslice", "Site_number", "Resampling", "MPI-ESM_ICE6G")
      ...
      for (i in 1:nrow(Coordinate_list_T31)) {
        ...
        if(nrow(subset_site)>0){
          ...
          if(nrow(subset_site) == 1) {
            ...
            # If there is only one site, assign its reconstruction value directly
            MPI_ICE6G_biome_timeslice_grid[MPI_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
            MPI_ICE6G_biome_timeslice_grid[MPI_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- subset_site$`MPI-ESM_ICE6G`
            ...
            if(sum(table(subset_site$`MPI-ESM_ICE6G`) == max(table(subset_site$`MPI-ESM_ICE6G`))) == 1) {
              ...
              # If no tie, assign the most frequent reconstruction value
              MPI_ICE6G_biome_timeslice_grid[MPI_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
              MPI_ICE6G_biome_timeslice_grid[MPI_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(subset_site$`MPI-ESM_ICE6G`))[which.max(table(subset_site$`MPI-ESM_ICE6G`))]
              
            } else {
              
              # Handle ties using sampling
              MPI_ICE6G_biome_timeslice_grid[MPI_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
              
              sampled_elements <- replicate(999, sample(names(table(subset_site$`MPI-ESM_ICE6G`)[table(subset_site$`MPI-ESM_ICE6G`) == max(table(subset_site$`MPI-ESM_ICE6G`))]), size = 1, replace = TRUE))
              
              MPI_ICE6G_biome_timeslice_grid[MPI_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
            }
          ...
          MPI_ICE6G_biome_timeslice_grid[MPI_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & MPI_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
  ...
  # (3) CLIMBER-X_GLAC1D
  {
    ...
    for(t in 1:length(timeslice_list)){
      ...
      # Subset the data for the current timeslice
      timeslice_subset <- subset(Reconstructed_simulated_biome_timeslice_site_0_21ka_excluded[ ,c(1:4,8)], Timeslice == timeslice_list[t])
      
      # Initialize a result matrix for the current timeslice
      CLIMBER_X_GLAC1D_biome_timeslice_grid <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
      colnames(CLIMBER_X_GLAC1D_biome_timeslice_grid) <- c("Longitude","Latitude", "Timeslice", "Site_number", "Resampling", "CLIMBER-X_GLAC1D")
      ...
      for (i in 1:nrow(Coordinate_list_T31)) {
        ...
        if(nrow(subset_site)>0){
          ...
          if(nrow(subset_site) == 1) {
            ...
            # If there is only one site, assign its reconstruction value directly
            CLIMBER_X_GLAC1D_biome_timeslice_grid[CLIMBER_X_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
            CLIMBER_X_GLAC1D_biome_timeslice_grid[CLIMBER_X_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- subset_site$`CLIMBER-X_GLAC1D`
            ...
            if(sum(table(subset_site$`CLIMBER-X_GLAC1D`) == max(table(subset_site$`CLIMBER-X_GLAC1D`))) == 1) {
              ...
              # If no tie, assign the most frequent reconstruction value
              CLIMBER_X_GLAC1D_biome_timeslice_grid[CLIMBER_X_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
              CLIMBER_X_GLAC1D_biome_timeslice_grid[CLIMBER_X_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(subset_site$`CLIMBER-X_GLAC1D`))[which.max(table(subset_site$`CLIMBER-X_GLAC1D`))]
              
            } else {
              
              # Handle ties using sampling
              CLIMBER_X_GLAC1D_biome_timeslice_grid[CLIMBER_X_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
              
              sampled_elements <- replicate(999, sample(names(table(subset_site$`CLIMBER-X_GLAC1D`)[table(subset_site$`CLIMBER-X_GLAC1D`) == max(table(subset_site$`CLIMBER-X_GLAC1D`))]), size = 1, replace = TRUE))
              
              CLIMBER_X_GLAC1D_biome_timeslice_grid[CLIMBER_X_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
            }
          ...
          CLIMBER_X_GLAC1D_biome_timeslice_grid[CLIMBER_X_GLAC1D_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_GLAC1D_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
  ...
  # (4) CLIMBER-X_ICE6G
  {
    ...
    for(t in 1:length(timeslice_list)){
      ...
      # Subset the data for the current timeslice
      timeslice_subset <- subset(Reconstructed_simulated_biome_timeslice_site_0_21ka_excluded[ ,c(1:4,9)], Timeslice == timeslice_list[t])
      
      # Initialize a result matrix for the current timeslice
      CLIMBER_X_ICE6G_biome_timeslice_grid <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
      colnames(CLIMBER_X_ICE6G_biome_timeslice_grid) <- c("Longitude","Latitude", "Timeslice", "Site_number", "Resampling", "CLIMBER-X_ICE6G")
      ...
      for (i in 1:nrow(Coordinate_list_T31)) {
        ...
        if(nrow(subset_site)>0){
          ...
          if(nrow(subset_site) == 1) {
            ...
            # If there is only one site, assign its reconstruction value directly
            CLIMBER_X_ICE6G_biome_timeslice_grid[CLIMBER_X_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
            CLIMBER_X_ICE6G_biome_timeslice_grid[CLIMBER_X_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- subset_site$`CLIMBER-X_ICE6G`
            ...
            if(sum(table(subset_site$`CLIMBER-X_ICE6G`) == max(table(subset_site$`CLIMBER-X_ICE6G`))) == 1) {
              ...
              # If no tie, assign the most frequent reconstruction value
              CLIMBER_X_ICE6G_biome_timeslice_grid[CLIMBER_X_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
              CLIMBER_X_ICE6G_biome_timeslice_grid[CLIMBER_X_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(subset_site$`CLIMBER-X_ICE6G`))[which.max(table(subset_site$`CLIMBER-X_ICE6G`))]
              
            } else {
              
              # Handle ties using sampling
              CLIMBER_X_ICE6G_biome_timeslice_grid[CLIMBER_X_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
              
              sampled_elements <- replicate(999, sample(names(table(subset_site$`CLIMBER-X_ICE6G`)[table(subset_site$`CLIMBER-X_ICE6G`) == max(table(subset_site$`CLIMBER-X_ICE6G`))]), size = 1, replace = TRUE))
              
              CLIMBER_X_ICE6G_biome_timeslice_grid[CLIMBER_X_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
            }
          ...
          CLIMBER_X_ICE6G_biome_timeslice_grid[CLIMBER_X_ICE6G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & CLIMBER_X_ICE6G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
  ...
  # (5) TRACE-21K-I_ICE5G
  {
    ...
    for(t in 1:length(timeslice_list)){
      ...
      # Subset the data for the current timeslice
      timeslice_subset <- subset(Reconstructed_simulated_biome_timeslice_site_0_21ka_excluded[ ,c(1:4,10)], Timeslice == timeslice_list[t])
      
      # Initialize a result matrix for the current timeslice
      TRACE_21K_I_ICE5G_biome_timeslice_grid <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
      colnames(TRACE_21K_I_ICE5G_biome_timeslice_grid) <- c("Longitude","Latitude", "Timeslice", "Site_number", "Resampling", "TRACE-21K-I_ICE5G")
      ...
      for (i in 1:nrow(Coordinate_list_T31)) {
        ...
        if(nrow(subset_site)>0){
          ...
          if(nrow(subset_site) == 1) {
            ...
            # If there is only one site, assign its reconstruction value directly
            TRACE_21K_I_ICE5G_biome_timeslice_grid[TRACE_21K_I_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_I_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
            TRACE_21K_I_ICE5G_biome_timeslice_grid[TRACE_21K_I_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_I_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- subset_site$`TRACE-21K-I_ICE5G`
            ...
            if(sum(table(subset_site$`TRACE-21K-I_ICE5G`) == max(table(subset_site$`TRACE-21K-I_ICE5G`))) == 1) {
              ...
              # If no tie, assign the most frequent reconstruction value
              TRACE_21K_I_ICE5G_biome_timeslice_grid[TRACE_21K_I_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_I_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
              TRACE_21K_I_ICE5G_biome_timeslice_grid[TRACE_21K_I_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_I_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(subset_site$`TRACE-21K-I_ICE5G`))[which.max(table(subset_site$`TRACE-21K-I_ICE5G`))]
              
            } else {
              
              # Handle ties using sampling
              TRACE_21K_I_ICE5G_biome_timeslice_grid[TRACE_21K_I_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_I_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
              
              sampled_elements <- replicate(999, sample(names(table(subset_site$`TRACE-21K-I_ICE5G`)[table(subset_site$`TRACE-21K-I_ICE5G`) == max(table(subset_site$`TRACE-21K-I_ICE5G`))]), size = 1, replace = TRUE))
              
              TRACE_21K_I_ICE5G_biome_timeslice_grid[TRACE_21K_I_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_I_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
            }
          ...
          TRACE_21K_I_ICE5G_biome_timeslice_grid[TRACE_21K_I_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_I_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
  ...
  # (6) TRACE-21K-II_ICE5G
  {
    ...
    for(t in 1:length(timeslice_list)){
      ...
      # Subset the data for the current timeslice
      timeslice_subset <- subset(Reconstructed_simulated_biome_timeslice_site_0_21ka_excluded[ ,c(1:4,11)], Timeslice == timeslice_list[t])
      
      # Initialize a result matrix for the current timeslice
      TRACE_21K_II_ICE5G_biome_timeslice_grid <- data.frame(matrix(NA, nrow=nrow(Coordinate_list_T31), ncol=6, byrow=TRUE))
      colnames(TRACE_21K_II_ICE5G_biome_timeslice_grid) <- c("Longitude","Latitude", "Timeslice", "Site_number", "Resampling", "TRACE-21K-II_ICE5G")
      ...
      for (i in 1:nrow(Coordinate_list_T31)) {
        ...
        if(nrow(subset_site)>0){
          ...
          if(nrow(subset_site) == 1) {
            ...
            # If there is only one site, assign its reconstruction value directly
            TRACE_21K_II_ICE5G_biome_timeslice_grid[TRACE_21K_II_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_II_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
            TRACE_21K_II_ICE5G_biome_timeslice_grid[TRACE_21K_II_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_II_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- subset_site$`TRACE-21K-II_ICE5G`
            ...
            if(sum(table(subset_site$`TRACE-21K-II_ICE5G`) == max(table(subset_site$`TRACE-21K-II_ICE5G`))) == 1) {
              ...
              # If no tie, assign the most frequent reconstruction value
              TRACE_21K_II_ICE5G_biome_timeslice_grid[TRACE_21K_II_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_II_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "no"
              TRACE_21K_II_ICE5G_biome_timeslice_grid[TRACE_21K_II_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_II_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(subset_site$`TRACE-21K-II_ICE5G`))[which.max(table(subset_site$`TRACE-21K-II_ICE5G`))]
              
            } else {
              
              # Handle ties using sampling
              TRACE_21K_II_ICE5G_biome_timeslice_grid[TRACE_21K_II_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_II_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5]     <- "yes"
              
              sampled_elements <- replicate(999, sample(names(table(subset_site$`TRACE-21K-II_ICE5G`)[table(subset_site$`TRACE-21K-II_ICE5G`) == max(table(subset_site$`TRACE-21K-II_ICE5G`))]), size = 1, replace = TRUE))
              
              TRACE_21K_II_ICE5G_biome_timeslice_grid[TRACE_21K_II_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_II_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 6]     <- names(table(sampled_elements))[which.max(table(sampled_elements))]
            }
          ...
          TRACE_21K_II_ICE5G_biome_timeslice_grid[TRACE_21K_II_ICE5G_biome_timeslice_grid$Longitude == Coordinate_list_T31[i, 1] & TRACE_21K_II_ICE5G_biome_timeslice_grid$Latitude == Coordinate_list_T31[i, 2], 5:6]   <- NA
...
Reconstructed_simulated_biome_timeslice_grid_0_21ka_final  <- full_join(Reconstructed_biome_timeslice_grid_0_21ka[ ,c(1:3,6)], MPI_GLAC1D_biome_timeslice_grid_0_21ka[ ,c(1:3,6)], by = c("Longitude", "Latitude", "Timeslice")) %>%
  full_join(MPI_ICE6G_biome_timeslice_grid_0_21ka[ ,c(1:3,6)], by = c("Longitude", "Latitude", "Timeslice")) %>%
  full_join(CLIMBER_X_GLAC1D_biome_timeslice_grid_0_21ka[ ,c(1:3,6)], by = c("Longitude", "Latitude", "Timeslice")) %>%
  full_join(CLIMBER_X_ICE6G_biome_timeslice_grid_0_21ka[ ,c(1:3,6)], by = c("Longitude", "Latitude", "Timeslice")) %>%
  full_join(TRACE_21K_I_ICE5G_biome_timeslice_grid_0_21ka[ ,c(1:3,6)], by = c("Longitude", "Latitude", "Timeslice")) %>%
  full_join(TRACE_21K_II_ICE5G_biome_timeslice_grid_0_21ka[ ,c(1:3,6)], by = c("Longitude", "Latitude", "Timeslice")) %>%
  full_join(Simulated_ensemble_biome_timeslice_grid_0_21ka[ ,c(1:3,6)], by = c("Longitude", "Latitude", "Timeslice")) 
...
# Bias calculation
{
  # (1) MPI-ESM_GLAC1D
  {
    # Downscale for CRU Data
    {
      ...
      Bioclimatic_variables_CRU_grid_0ka_global_MPI_GLAC1D           <- data.frame(matrix(999, nrow= nrow(coordinate_list), ncol= ncol(Cliamte_0ka_MPI_GLAC1D_global)+1, byrow=TRUE))
  ...
  # (2) MPI-ESM_ICE6G
  {
    # Downscale for CRU Data
    {
      ...
      # Initialize a result matrix for downscaled CRU data
      Bioclimatic_variables_CRU_grid_0ka_global_MPI_ICE6G           <- data.frame(matrix(999, nrow= nrow(coordinate_list), ncol= ncol(Cliamte_0ka_MPI_ICE6G_global)+1, byrow=TRUE))
  ...
  # (3) CLIMBER-X_GLAC1D
  {
    # Downscale for CRU Data
    {
      ...
      # Initialize a result matrix for downscaled CRU data
      Bioclimatic_variables_CRU_grid_0ka_global_CLIMBER_GLAC1D           <- data.frame(matrix(999, nrow= nrow(coordinate_list), ncol= ncol(Cliamte_0ka_CLIMBER_GLAC1D_global)+1, byrow=TRUE))
  ...
  # (4) CLIMBER-X_ICE6G
  {
    # Downscale for CRU Data
    {
      ...
      # Initialize a result matrix for downscaled CRU data
      Bioclimatic_variables_CRU_grid_0ka_global_CLIMBER_ICE6G           <- data.frame(matrix(999, nrow= nrow(coordinate_list), ncol= ncol(Cliamte_0ka_CLIMBER_ICE6G_global)+1, byrow=TRUE))
  ...
  # (5) TRACE-21K-I_ICE5G
  {
    # Downscale for CRU Data
    {
      ...
      # Initialize a result matrix for downscaled CRU data
      Bioclimatic_variables_CRU_grid_0ka_global_TRACE_I           <- data.frame(matrix(999, nrow= nrow(coordinate_list), ncol= ncol(Cliamte_0ka_TRACE_I_global)+1, byrow=TRUE))
  ...
  # (6) TRACE-21K-II_ICE5G
  {
    # Downscale for CRU Data
    {
      ...
      # Initialize a result matrix for downscaled CRU data
      Bioclimatic_variables_CRU_grid_0ka_global_TRACE_II           <- data.frame(matrix(999, nrow= nrow(coordinate_list), ncol= ncol(Cliamte_0ka_TRACE_II_global)+1, byrow=TRUE))
